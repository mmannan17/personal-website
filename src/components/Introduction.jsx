  ...
  return (
    <div className="intro-container">
        ...
        <div id='navsec'>
          ...
          <button className="section-button" onClick={() => scrollTo('project-title')}>Projects</button>
          <button className="section-button" onClick={() => scrollTo('experience-title')}>Experience</button>
